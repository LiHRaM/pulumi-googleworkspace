module github.com/lihram/pulumi-googleworkspace/provider
...
replace github.com/hashicorp/terraform-provider-googleworkspace/shim => ./shim

require (
	github.com/hashicorp/terraform-provider-googleworkspace/shim v0.0.0
...
require (
	...
	github.com/hashicorp/terraform-provider-googleworkspace v0.7.0 // indirect
