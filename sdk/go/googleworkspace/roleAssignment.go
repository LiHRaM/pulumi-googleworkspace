...
func NewRoleAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("googleworkspace:index/roleAssignment:RoleAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoleAssignment(ctx *pulumi.Context,
	...
	var resource RoleAssignment
	err := ctx.ReadResource("googleworkspace:index/roleAssignment:RoleAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o RoleAssignmentOutput) AssignedTo() pulumi.StringOutput {
	return o.ApplyT(func(v *RoleAssignment) pulumi.StringOutput { return v.AssignedTo }).(pulumi.StringOutput)
}

// ETag of the resource.
func (o RoleAssignmentOutput) Etag() pulumi.StringOutput {
	return o.ApplyT(func(v *RoleAssignment) pulumi.StringOutput { return v.Etag }).(pulumi.StringOutput)
}

// If the role is restricted to an organization unit, this contains the ID for the organization unit the exercise of this
// role is restricted to.
func (o RoleAssignmentOutput) OrgUnitId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RoleAssignment) pulumi.StringPtrOutput { return v.OrgUnitId }).(pulumi.StringPtrOutput)
}
...
// The scope in which this role is assigned. Valid values are : - `CUSTOMER` - `ORG_UNIT`
func (o RoleAssignmentOutput) ScopeType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RoleAssignment) pulumi.StringPtrOutput { return v.ScopeType }).(pulumi.StringPtrOutput)
}
