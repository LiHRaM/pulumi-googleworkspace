...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `googleworkspace` with the `NAME` of your provider.
...
├── config.yaml
├── metadata.json
├── pulumi-googleworkspace_darwin_amd64_v1
│   └── pulumi-resource-googleworkspace
├── pulumi-googleworkspace_darwin_arm64
│   └── pulumi-resource-googleworkspace
├── pulumi-googleworkspace_linux_amd64_v1
│   └── pulumi-resource-googleworkspace
├── pulumi-googleworkspace_linux_arm64
│   └── pulumi-resource-googleworkspace
├── pulumi-googleworkspace_windows_amd64_v1
│   └── pulumi-resource-googleworkspace.exe
└── pulumi-googleworkspace_windows_arm64
    └── pulumi-resource-googleworkspace.exe
```
